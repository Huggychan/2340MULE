...
public class DecrementMoneyTest {
    ...
    public void testMoneyGreaterAmount() {
        ...
        // player has enough money to buy, so should decrement only money by 10 to 90
    ...
    public void testMoneyLessAmount() {
        ...
        assertEquals(p.getEnergy(), 100);
        assertEquals(p.getCrystite(), 100);
        // player does not have enough money to buy, so should not decrement anything
        // no change to resources
    }
    ...
    public void testMoneyEqualAmount() {
        ...
        assertEquals(p.getEnergy(), 100);
        assertEquals(p.getCrystite(), 100);
        // player has exact amount of money, so should show money equal to 0
        // no change to resources
    }
}